...
public class Hand {
    ...
    protected void addCard(Card c) {
        ...
        /**
         * when first getting a 5-card hand or when redrawing back to a 5-card
         * hand, it's important to order it by rank (ascending)
         */
    ...
    /**
     * comparator class for Card class used for sorting hand
     */
